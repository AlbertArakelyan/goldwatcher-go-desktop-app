...
func main() {
	...
	// create a fyne app
	fyneApp := app.NewWithID("am.gocode.goldwatcher.preferences")
	myApp.App = fyneApp
	myApp.App.Settings().SetTheme(theme.LightTheme()) // will be removed in fyne v3
	...
	currency = fyneApp.Preferences().StringWithFallback("currence", "USD")
